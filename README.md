...
包含 **后端服务、管理端后台、小程序端前台** 三部分，便于学习、演示与二次开发。
...
- 业务骨架完整：商品、分类、购物车、订单、后台管理等核心链路齐全
- 技术栈通用：适合学习、答辩展示、简历项目包装与二次开发
- 预留扩展位：Redis、RabbitMQ、OSS、微信能力接入位保留

---

## 项目简介

本项目围绕“数码零售商城”场景整理，目标不是只提供一套页面，而是提供可继续开发、可本地运行、可二次改造的商城系统基础版本。
